...
If you are completely new, begin with the **[Quick Start Guide]({{< ref "/00-quick-start" >}})** — it walks you through the minimum steps to get your robot up and running.

After that, dive into the sections that match what you want to do:

| Section | What it covers |
|---|---|
| [Quick Start]({{< ref "/00-quick-start" >}}) | Robot setup to first running program — minimal steps |
| [raccoon-cli]({{< ref "/01-raccoon-cli" >}}) | All CLI commands for managing projects and the robot |
